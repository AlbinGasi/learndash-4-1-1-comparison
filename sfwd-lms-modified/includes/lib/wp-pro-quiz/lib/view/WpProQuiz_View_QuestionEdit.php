...
<div class="wrap wpProQuiz_questionEdit">
			...
			<div class="postbox" id="wpProQuiz_answers">
				...
				<div class="inside answer_felder">
					...
					<div class="sort_answer">
						...
						<input type="button" class="button-primary addAnswer" data-default-value="<?php echo esc_attr( LEARNDASH_LMS_DEFAULT_ANSWER_POINTS ); ?>" value="<?php esc_html_e( 'Add answer', 'learndash' ); ?>">
					</div>
	...
	<li style="border-bottom:1px dotted #ccc; padding-bottom: 5px; background-color: white;" id="TEST">
		<table style="width: 100%;border:none;border-collapse: collapse; margin-bottom: 0;">
			<thead>
				<tr>
					<th style="padding: 5px;"></th>
					<th style="padding: 5px 5px 5px 12px;border:none;"><?php esc_html_e( 'Answer', 'learndash' ); ?></th>
                    <th width="160px" style="border:none;padding: 5px;"><?php esc_html_e( 'Options', 'learndash' ); ?></th>
                    <th style="padding: 5px;"></th>
				</tr>
			</thead>
			<tbody>
				<tr>
					...
					<td style="padding: 5px 5px 10px 12px;border:none;vertical-align: top;">
                    ...
                    <td style="padding: 5px; vertical-align: top;border:none;width: 210px;">
                        <div style="display:flex;width:100%">
                            ...
                            <div style="width:50%;margin-top:-5px">
                                <a class="button-primary tbq-deleteAnswer-btn" href="javaScript:void(0)"><span><?php esc_html_e( 'Delete answer', 'learndash' ); ?></span></a>
		...
		<input type="button" name="submit" class="button-primary deleteAnswer" style="display:none;" value="<?php esc_html_e( 'Delete answer', 'learndash' ); ?>">
<!--		<input type="button" class="button-secondary addMedia" value="--><?php //esc_html_e( 'Add Media', 'learndash' ); ?><!--">-->
<!--		<a href="#" class="button-secondary wpProQuiz_move" style="cursor: move;">--><?php //esc_html_e( 'Move', 'learndash' ); ?><!--</a>-->
	...
	public function matrixSortingChoice( $data ) {
		foreach ( $data as $d ) {
			?>
			<li style="border-bottom:1px dotted #ccc; padding-bottom: 5px; background-color: white;">
				<table style="width: 100%;border: none;border-collapse: collapse; margin-bottom:0;">
					<thead>
						<tr>
                            <th style="padding: 5px;"></th>
							<th style=" border: none; padding: 5px; "><?php esc_html_e( 'Criterion', 'learndash' ); ?></th>
							<th style="padding: 5px;"><?php esc_html_e( 'Sort elements', 'learndash' ); ?></th>
                            <th width="130px" style=" border: none; padding: 5px; "><?php esc_html_e( 'Options', 'learndash' ); ?></th>
						</tr>
					</thead>
					<tbody>
						<tr>
                            <td width="40">
                                <a href="#" class="button-secondary wpProQuiz_move" style="cursor: move;"></a>
                            </td>
